...
;(async function () {
	...
	const ingredients = await Ingredient.create([
        ...
        {name:'Tortellini',price:2, emoji:'image.png', isAvailable:true},
        {name:'Penne',price:2, emoji:'image.png', isAvailable:true},
        {name:'Orzo',price:2, emoji:'image.png', isAvailable:true},
        {name:'Ravioli',price:2, emoji:'image.png', isAvailable:true},
